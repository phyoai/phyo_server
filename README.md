...
- **Bright Data Integration**: Real-time Instagram data scraping for enhanced influencer profiles
...
- **Bright Data** - Real-time web data scraping
...
- [Environment Setup Guide](docs/environment-setup.md) - Complete setup instructions
- [Bright Data Integration](docs/brightdata-integration.md) - Real-time Instagram data enhancement
- [Bright Data Testing](docs/brightdata-testing.md) - Testing the Bright Data integration
- [Campaign API Documentation](docs/CAMPAIGN_API_DOCS.md) - Campaign management endpoints
- [Chat System Guide](docs/chat-system.md) - Real-time messaging system
