...
import { uploadToS3, uploadImageToS3, deleteFromS3, getFileTypeCategory } from '../services/s3';
...
export const uploadChatFile = async (req: AuthenticatedRequest<{}, {}, UploadFileBody>, res: Response): Promise<void> => {
  try {
...
export const deleteChatFile = async (req: AuthenticatedRequest<{ key: string }>, res: Response): Promise<void> => {
  try {
